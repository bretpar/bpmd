...
const Footer = () => (
  <footer className="bg-foreground text-primary-foreground">
    <div className="container mx-auto px-4 lg:px-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2 text-sm text-primary-foreground/70">
            ...
            <Link to="/exercise-library" className="hover:text-primary-foreground transition-colors">Patient Exercises</Link>
      ...
      <div className="border-t border-primary-foreground/20 mt-10 pt-6 text-center text-sm text-primary-foreground/80">
